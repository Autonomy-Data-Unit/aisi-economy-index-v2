...
__all__ = ['REMOTE_LOG', 'REMOTE_PID', 'kill_bg', 'log', 'run_bg', 'start']
...
# %% nbs/deploy/run_pipeline.ipynb 4
def run_bg():
...
# %% nbs/deploy/run_pipeline.ipynb 5
def start():
...
# %% nbs/deploy/run_pipeline.ipynb 6
def log():
...
# %% nbs/deploy/run_pipeline.ipynb 7
def kill_bg():
