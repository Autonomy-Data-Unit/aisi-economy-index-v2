...
__all__ = ['EMBED_FIXED_NODES', 'EMBED_PER_AD_NODES', 'EMBED_RESULTS_DIR', 'LLM_NODES', 'LLM_RESULTS_DIR', 'main']
...
# %% nbs/calibration/estimate.ipynb 6
...
# %% nbs/calibration/estimate.ipynb 7
def main():
