...
__all__ = ['SlurmJob', 'acancel', 'ajob_log', 'ajob_state', 'astatus', 'asubmit', 'await_job', 'cancel', 'job_log', 'job_state', 'status', 'submit', 'wait']
...
# %% nbs/isambard_utils/slurm.ipynb 17
...
# %% nbs/isambard_utils/slurm.ipynb 18
