# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/isambard_utils/sbatch.ipynb

__all__ = ['SbatchConfig', 'generate']

# %% nbs/isambard_utils/sbatch.ipynb 2
from dataclasses import dataclass, field
from .config import IsambardConfig
from .ssh import _get_config

# %% nbs/isambard_utils/sbatch.ipynb 3
@dataclass
class SbatchConfig:
...
# %% nbs/isambard_utils/sbatch.ipynb 4
...
# %% nbs/isambard_utils/sbatch.ipynb 5
