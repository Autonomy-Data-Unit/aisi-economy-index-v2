...
__all__ = ['acosine_topk', 'aembed', 'allm_generate', 'build_insert_from_parquet', 'cosine_topk', 'embed', 'ensure_ads_table', 'ensure_duckdb_table', 'get_ads_by_id', 'get_adzuna_conn', 'get_all_ad_ids', 'llm_generate', 'pydantic_to_duckdb_columns']
