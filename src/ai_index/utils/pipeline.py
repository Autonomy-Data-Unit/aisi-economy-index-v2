# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/ai_index/utils/pipeline.ipynb

__all__ = ['build_run_defs', 'check_run_integrity', 'clean_incomplete_nodes', 'clean_store_main', 'get_sample_n', 'is_run_complete', 'make_run_name']

# %% nbs/ai_index/utils/pipeline.ipynb 2
import copy
from pathlib import Path

from ..const import run_defs_path, pipeline_store_path
...
def build_run_defs(base_run: str, run_name: str, overrides: dict | None = None) -> dict:
    ...
    """
    from ..run_pipeline import _load_run_defs
