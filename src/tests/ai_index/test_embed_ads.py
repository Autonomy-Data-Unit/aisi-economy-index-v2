# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/tests/ai_index/test_embed_ads.ipynb

__all__ = ['SAMPLE_ADS', 'TestOutput', 'TestPromptSupport', 'TestTextConstruction']

# %% nbs/tests/ai_index/test_embed_ads.ipynb 2
import json
...
# %% nbs/tests/ai_index/test_embed_ads.ipynb 4
...
# %% nbs/tests/ai_index/test_embed_ads.ipynb 6
...
# %% nbs/tests/ai_index/test_embed_ads.ipynb 8
...
# %% nbs/tests/ai_index/test_embed_ads.ipynb 10
class TestOutput:
