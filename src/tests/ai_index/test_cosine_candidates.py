# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/tests/ai_index/test_cosine_candidates.ipynb

__all__ = ['AD_EMBEDDINGS', 'ONET_CODES', 'ONET_EMBEDDINGS', 'ONET_TARGETS_DF', 'ONET_TITLES', 'TestCandidateSelection', 'TestCosineScores', 'TestOutput']

# %% nbs/tests/ai_index/test_cosine_candidates.ipynb 2
import asyncio
import json
...
# %% nbs/tests/ai_index/test_cosine_candidates.ipynb 4
...
# %% nbs/tests/ai_index/test_cosine_candidates.ipynb 6
...
# %% nbs/tests/ai_index/test_cosine_candidates.ipynb 8
...
# %% nbs/tests/ai_index/test_cosine_candidates.ipynb 10
class TestOutput:
