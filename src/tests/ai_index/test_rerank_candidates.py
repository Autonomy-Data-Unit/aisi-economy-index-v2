# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/tests/ai_index/test_rerank_candidates.ipynb

__all__ = ['ONET_TARGETS', 'SAMPLE_ADS_TABLE', 'SAMPLE_CANDIDATES', 'TestOutput', 'TestReranking']

# %% nbs/tests/ai_index/test_rerank_candidates.ipynb 2
import asyncio
import json
...
# %% nbs/tests/ai_index/test_rerank_candidates.ipynb 4
...
# %% nbs/tests/ai_index/test_rerank_candidates.ipynb 6
class TestReranking:
