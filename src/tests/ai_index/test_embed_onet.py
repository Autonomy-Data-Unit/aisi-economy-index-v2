# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/tests/ai_index/test_embed_onet.ipynb

__all__ = ['SAMPLE_ONET', 'TestOutput', 'TestPromptSupport', 'TestSkipLogic', 'TestTextConstruction']

# %% nbs/tests/ai_index/test_embed_onet.ipynb 2
import asyncio
import json
...
# %% nbs/tests/ai_index/test_embed_onet.ipynb 4
...
# %% nbs/tests/ai_index/test_embed_onet.ipynb 6
...
# %% nbs/tests/ai_index/test_embed_onet.ipynb 8
...
# %% nbs/tests/ai_index/test_embed_onet.ipynb 10
class TestSkipLogic:
...
# %% nbs/tests/ai_index/test_embed_onet.ipynb 12
class TestOutput:
