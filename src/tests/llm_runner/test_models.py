# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/tests/llm_runner/test_models.ipynb

__all__ = ['TestApiLLM']

# %% nbs/tests/llm_runner/test_models.ipynb 2
from unittest.mock import AsyncMock, MagicMock, patch

import pytest

# %% nbs/tests/llm_runner/test_models.ipynb 3
class TestApiLLM:
